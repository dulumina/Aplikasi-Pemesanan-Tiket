					...
					<?php foreach ($ticket as $key) { ?>
						...
						<div class="col-lg-3 col-md-6 single-price">
							...
							<div class="package-list">
								<ul>
									<li>
										<font color="black">Entry Before <?php echo $key->startTime; ?></font>
									</li>
								</ul>
							</div>
...
<?php } else { ?>
	...
	<div class="title text-center">
		<h3 class="mb-10" style="color: #f4bd00">Ticket is not available</h3>
	</div>
...
<?php if (is_array($sche)) { ?>
	<section class="spekers-area pb-100" id="speakers">
		<br>
		<center>
			<h1>Our Upcoming Events in This Month</h1>
		</center>
		<br>
...
<?php } else { ?>
	<section class="spekers-area pb-100" id="speakers">
		...
		<br>
		<center>
			<h3>There's no upcoming events</h3>
		</center>
	<?php } ?>
	</section>
