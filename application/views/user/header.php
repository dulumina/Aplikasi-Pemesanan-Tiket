				...
				<div class="row align-items-center justify-content-between d-flex">
					...
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<li class=""><a href="<?php echo site_url('Order/orderUserTable'); ?>/Contact">My Tickets</a></li>

							<li class="menu-has-children"><a href=""><?php if (empty($username)) { ?>Account<?php } else { ?><span class="fa fa-user"></span>&nbsp;<?php echo $username;
																																																																							} ?></a>
								<ul>
								...
								<li class="menu-has-children"><a href=""><span class="fa fa-bell"></span>
									...
									<ul>
										<?php if (is_array($notif)) {
												...
												<li><a href="<?php echo site_url() ?>/HomeUser/update/<?php echo $key->idOrder ?>">
														<h5>ID ORDER : <?php echo $key->idOrder ?></h5> Your Order Has Been Confirmed
													</a></li>
										<?php }
											} ?>
									</ul>
						...
						<li><a class="ticker-btn" href="#price"><span class="fa fa-lg fa-shopping-cart"></span></a></li>
						</ul>
