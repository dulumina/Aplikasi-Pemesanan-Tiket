					...
					<div class="container" style="padding-left: 10px;padding-bottom: 5px">
						<div class="row">
							<div class="col-4">
								...
								<h1><?php echo $key->name ?> <br>By <?php echo $key->artist ?></h1>
							</div>
							<div class="col-6">
								...
								<br>
								<pre>Barcode<br></pre>
								<!-- <img src="<?php base_url() ?>./assets/imgEvent/barcode/<?php echo $key->barcodePic ?>"> -->
								<img href="<?php base_url() ?>./assets/imgEvent/barcode/<?php echo $key->barcodePic ?>">
							</div>
						</div>
					</div>
				</div>
